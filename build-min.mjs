...
//   2. Flipping DIAG to false lets dead-code elimination drop the WGSL compile-log formatter,
//      which drop:console cannot remove on its own: it builds a string with .split/.padStart,
//      and esbuild has to assume those might have side effects.
//
